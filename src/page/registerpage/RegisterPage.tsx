...
import RegisterBgImg from "../../assets/Cadastro.png";
...
const RegisterPage = () => {
  ...
  return (
    <>
      ...
      <div className="w-full" style={{backgroundImage: `url(${RegisterBgImg})`, backgroundSize: 'cover', backgroundPosition: 'center', height: '100vh'}}>
        <div className="flex flex-col mx-auto my-auto">
          <h3 className="px-6 text-lg md:text-2xl text-center mt-4 mb-0 font-bold">
            Cadastrar
          </h3>
